...
// impl<C> std::fmt::Debug for Connection<C> {
...
// #[async_trait]
// impl<Conn> crate::async_trait::AsyncSimpleConnection<Conn> for Connection<Conn>
// where
...
// #[async_trait]
// impl<Conn> crate::async_trait::AsyncConnection<Conn> for Connection<Conn>
// where
//     Conn: 'static + R2D2Connection,
//     Connection<Conn>: crate::async_trait::AsyncSimpleConnection<Conn>,
// {
